...
551-214-7115 | <sharif.haason@gmail.com> | linkedin.com/in/sharif-haason/ | github.com/sharifhsn/ | South River, NJ  
**EDUCATION**
**Stevens Institute of Technology, School of Business** | Hoboken, NJ Expected: Dec 2025  
Master of Science, Financial Engineering **GRE: 335/340**

* **Awards & Honors:** Stevens Master’s Scholarship  
* **Relevant Coursework:** Interest Rate Derivatives, Computational Methods, Risk Management, Pricing and Hedging, Portfolio Theory, Quantitative Hedge Fund Strategy

**Rutgers University, School of Arts and Sciences** | New Brunswick, NJ Jan 2024  
Bachelor of Science, Computer Science

* **Awards & Honors:** Rutgers Honors College, Trustee Scholarship, National Merit Scholarship  
* **Relevant Coursework:** Data Science, Linear Algebra, Discrete Math, Data Structures, Design and Analysis of Algorithms, Artificial Intelligence, Computer Architecture, Systems Programming, Internet Technology

**PROFESSIONAL EXPERIENCE**
**El Mashta LLC** | New York, NY      Jun 2025 \- Present  
*DevOps Consultant*

* Provisioned servers for general development workload, GPU inference, and GPU training, cutting $300/month in server costs  
* Set up development infrastructure to improve developer convenience, with declarative infrastructure as code through Terraform  
* Created and maintained organizational infrastructure for team communication and consistency in tool usage

**Stevens Institute of Technology** | Hoboken, NJ Sept 2024 \- Present  
*Hanlon Financial Systems Team Lead*

* Builds server infrastructure like virtual machines and software installation for distributed deep learning on H100 GPUs  
...
**Cloudnosys, Inc** | Atlanta, GA Jun 2023 \- Sept 2024  
*DevSecOps Engineer*

* Developed security control methods in JavaScript with the AWS SDK API for an auditing service on AWS cloud accounts  
* Exposed OS vulnerabilities, misconfigurations, and malware that contained alert metadata from AWS documentation on them  
* Managed an AWS cloud account for the purposes of debugging signatures and configured it to test security flaw detections

**Rutgers University** | Newark, NJ Jun 2021 \- Jun 2023  
...
**PROJECTS**
**Master’s Thesis on Implied Willow Tree for Interest Rate Derivatives** | MATLAB, Research Jun 2025 \- Present
...
**High Frequency Trading Competition** | Python, SHIFT Mar 2025 \- May 2025
...
**Hornet Trading Contest** | Excel, VBA   Feb 2025 \- May 2025
...
**NBA Defensive Impact Analysis** | Python, Pandas Jul 2024 \- Aug 2024
...
**Hexyl \- Terminal Hex Viewer** | Rust, GitHub Sept 2022 \- Dec 2023
...
**Rutgers Book Club** | New Brunswick, NJ Sept 2020 \- May 2023  
*Treasurer*

* Secured $800 in additional funding in a meeting with the Rutgers Student Assembly by demonstrating how our number of members and our savings on our deal with Barnes & Noble made us a candidate for extra allocation after initial funding of $100

**SKILLS**  
**Skills:** Python, JavaScript, Git, Linux, Bash, SQL, AWS, React, Rust, C++, C, LLMs, Azure, Power Apps, Office 365, Databricks  
**Certifications:** AWS Solutions Architect, AWS Developer, Azure Fundamentals, Databricks Data Engineer Associate
